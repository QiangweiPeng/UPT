...
if __name__ == "__main__":
  ...
  parser.add_argument("--genes", type = str, help = "candidate gene list")
  parser.add_argument("--out", type = str, help = "output file with .pkl format")
  args = parser.parse_args()

  args.genes = "../data/vcc_data/target_genes.csv"
  args.out = "../data/vcc_data/vcc_data_target_genes_embedding.pkl"
